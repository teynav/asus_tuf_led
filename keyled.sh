...
echo MODE =$MODE=
echo SPEED =$SPEED=
sudo -A sh -c "echo $RED > /sys/devices/platform/faustus/kbbl/kbbl_red"
sudo -A sh -c "echo $GREEN > /sys/devices/platform/faustus/kbbl/kbbl_green"
sudo -A sh -c "echo $BLUE > /sys/devices/platform/faustus/kbbl/kbbl_blue"
sudo -A sh -c "echo $MODE > /sys/devices/platform/faustus/kbbl/kbbl_mode"
sudo -A sh -c "echo $SPEED > /sys/devices/platform/faustus/kbbl/kbbl_speed"
sudo -A sh -c "echo 2a > /sys/devices/platform/faustus/kbbl/kbbl_flags"
sudo -A sh -c "echo 1 > /sys/devices/platform/faustus/kbbl/kbbl_set"
